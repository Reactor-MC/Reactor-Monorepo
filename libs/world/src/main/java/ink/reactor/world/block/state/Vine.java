...
public final class Vine {
    public static int of(final char id, final boolean east, final boolean north, final boolean south, final boolean up, final boolean west) {
        final String sentence = east+"-"+north+"-"+south+"-"+up+"-"+west;
